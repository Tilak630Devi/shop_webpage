...
export default function CheckoutConfirmationPage() {
  ...
  const whatsappUrl = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER}?text=Hi, I need help with my order`
  ...
  const handleWhatsAppRedirect = () => {
    try {
      ...
      // If even window.open fails, fallback
      window.location.href = whatsappUrl
    }
  }
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <GlassCard className="p-8">
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Your order has been initiated. Please continue on WhatsApp to
                  complete your purchase. Our team will process your order once
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <GradientButton onClick={handleWhatsAppRedirect} size="lg">
                      Go to WhatsApp
                    </GradientButton>
                    <GradientButton
                      variant="secondary"
              ...
              <div className="mt-8">
                <GlassCard className="p-6">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    If you didn’t receive the WhatsApp redirect or have any
